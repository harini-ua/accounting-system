...
class PersonRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'salary' => 'required|numeric|max:99999.99|min:0',
            ...
            'last_salary' => 'nullable|numeric|max:99999.99|min:0',
            'growth_plan' => 'boolean',
            'tech_lead' => 'boolean',
            'tech_lead_reward' => 'nullable|numeric|max:99999.99|min:0',
            'team_lead' => 'boolean',
            'team_lead_reward' => 'nullable|numeric|max:99999.99|min:0',
            'bonuses' => 'boolean',
