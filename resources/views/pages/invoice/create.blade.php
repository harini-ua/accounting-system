...
{{-- page Title --}}
@section('title', __('Invoice Create'))
                    ...
                    <div class="card-content px-36">
                        ...
                        <div class="row mb-3">
                            <div class="col xl4 m12 display-flex align-items-center">
                                <input type="text" value="{{ isset($invoice) ?? $invoice->number }}" placeholder="{{ __('INV-00000') }}" disabled>
                            </div>
                                ...
                                <div class="invoice-date-picker display-flex align-items-center">
                                    <div class="display-flex align-items-center">
                                        ...
                                        <div class="display-flex ml-4">
                                            <input type="text" id="date" value="{{ isset($invoice) ?? $invoice->date }}" class="datepicker mr-2 mb-1" placeholder="{{ __('Select Date') }}">
                                        </div>
                                    </div>
                                    <div class="display-flex align-items-center">
                                        <small>{{ __('Plan Income Date') }}</small>
                                        <div class="display-flex ml-4">
                                            <input type="text" id="plan_income_date" value="{{ isset($invoice) ?? $invoice->plan_income_date }}" class="datepicker mb-1" placeholder="{{ __('Select Date') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col m6 s12 pull-m6">
                                ...
                                <div class="input-field">
                                    <input id="name" value="{{ isset($invoice) ?? $invoice->name }}" type="text">
                                        ...
                                        <div class="invoice-item display-flex mb-1">
                                            <div class="invoice-item-filed row pt-1">
                                                <div class="col s12 m3 input-field">
                                                    <input type="text" name="items[0]title" class="item-title">
                                                    <label for="title">{{ __('Item Title') }}</label>
                                                </div>
                                                <div class="col m3 s12 input-field">
                                                    <select name="items[0]type" class="select2-icons invoice-item-select browser-default item-type">
                                                ...
                                                <div class="col m2 s12 input-field">
                                                    <input type="text" name="items[0]qty" class="item-qty" placeholder="0">
                                                </div>
                                                <div class="col m2 s12 input-field">
                                                    <input type="text" name="items[0]rate" class="item-rate" placeholder="$ 0.00">
                                                </div>
                                                <div class="col m2 s12 input-field">
                                                    <input type="text" name="items[0]sum" class="item-sum"  placeholder="$ 0.00" disabled>
                                                </div>
                                                <div class="col m12 s12 input-field">
                                                    <textarea name="items[0]description" class="item-description materialize-textarea"></textarea>
                        ...
                        <div class="invoice-subtotal">
                            <div class="row">
                                <div class="col m5 s12">
                                    <div class="input-field">
                                        <input id="discount" type="text" value="{{ isset($invoice) ?? $invoice->discount }}" placeholder="{{ __('0.00') }}">
                                    ...
                                    <div class="input-field">
                                        <select id="sales_manager_id" class="select2 invoice-item-select browser-default">
                                            ...
                                            @foreach($sales as $user)
                                                <option value="{{ $user->id }}" {{ isset($invoice) && $invoice->sales_manager_id == $user->id  ? 'selected' : '' }}>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
