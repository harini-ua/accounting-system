    ...
    <div class="row" data-pjax>
        @if($person)
            <div class="col s12 m6">
                ...
                >
                    ...
                    <x-input
                        ...
                        title="{{ __('Position') }}"
                        type="text"
                        value="{{ \App\Enums\Position::getDescription($person->position_id) }}"
                        disabled="true"
                    ></x-input>
                    <x-input
                        name="salary_type"
                        ...
                        type="text"
                        value="{{ \App\Enums\SalaryType::getDescription($person->salary_type) }}"
                        disabled="true"
                    ></x-input>
                    <x-input
                        name="contracts"
                        title="{{ __('Type of contracts') }}"
                        type="text"
                        value="{{ \App\Enums\PersonContractType::getDescription($person->contract_type) }}"
                        disabled="true"
                    ></x-input>
                    <x-input
                        name="salary"
                        title="{{ __('Salary') }}"
                        type="text"
                        value="{{ \App\Services\Formatter::currency($person->salary, \App\Enums\Currency::symbol($person->currency)) }}"
                        disabled="true"
                    ></x-input>
                    <x-input
                        name="currency"
                        title="{{ __('Currency') }}"
                        type="text"
                        value="{{ \App\Enums\Currency::getDescription($person->currency) }}"
                        disabled="true"
                    ></x-input>
                    <x-input
                        name="hourly_rate"
                        title="{{ __('Hourly rate') }}"
                        type="text"
                        value="{{ \App\Services\Formatter::currency($person->rate, \App\Enums\Currency::symbol($person->currency)) }}"
                        disabled="true"
                    ></x-input>
                </div>
            </div>
            <div class="col s12 m6">
                ...
                <x-input
                    name="worked_hours"
                    title="{{ __('Number worked hours') }}"
                    type="number"
                    :model="$model"
                ></x-input>
                <x-input
                    name="basic_salary"
                    title="{{ __('Basic salary') }}"
                    :model="$model"
                    disabled="true"
                ></x-input>
                <x-input
                ...
                <x-input
                    name="vacations"
                    title="{{ __('Vacation ') . Str::plural('day', $model->vacations) }}"
                    :model="$model"
                    disabled="true"
                ></x-input>
                <x-input
                    name="vacation_compensation"
                    title="{{ __('Vacation compensation') }}"
                    :model="$model"
                    disabled="true"
                    icon="{{ \App\Enums\Currency::symbol($person->currency) }}"
                ></x-input>
                <x-input
                    name="leads"
                    title="{{ __('Leads') }}"
                ...
                ></x-input>
                <x-input
                    name="tax_compensation"
                    title="{{ __('Tax compensation') }}"
                    :model="$model"
                    disabled="true"
                ></x-input>
                <x-input
                    name="other_compensation"
                    title="{{ __('Other compensation') }}"
                    :model="$model"
                ></x-input>
                <x-input
                    name="total_usd"
