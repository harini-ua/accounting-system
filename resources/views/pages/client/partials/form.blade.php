...
<form id="update-clients" method="POST" action="{{ isset($client) ? route('clients.update', $client) : route('clients.store') }}">
    ...
    <div class="row">
        <div class="input-field col s12">
            ...
            @error('name')
            <small class="errorTxt2"><div id="cemail-error" class="error">{{ $message }}</div></small>
            @enderror
        </div>
    </div>
    <div class="row">
